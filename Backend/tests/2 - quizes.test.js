  ...
  it('Success', done => {
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        res.body.data.creator.should.have.property('id')
        res.body.data.creator.should.have.property('name')
        res.body.data.creator.name.should.be.a('string')
        res.body.data.should.have.property('time')
        res.body.data.time.should.be.a('string')
        res.body.data.should.have.property('questions')
        res.body.data.questions.should.be.a('array')
        res.body.data.questions[0].should.have.property('question')
        res.body.data.questions[0].should.have.property('options')
        res.body.data.questions[0].should.not.have.property('answer')
        res.body.data.questions[0].options.should.be.a('array')
        done()
      })
  })
})
